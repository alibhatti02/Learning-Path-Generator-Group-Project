...
<header>
  ...
  <p class="meta">Level: ${escapeHtml(level)} &nbsp;·&nbsp; Commitment: ${escapeHtml(hoursPerDay)} hrs/day &nbsp;·&nbsp; Duration: ${escapeHtml(data.calculated_total_weeks)} weeks &nbsp;·&nbsp; Generated by PathCraft</p>
</header>
${weeksHtml}
${outcomesHtml}
